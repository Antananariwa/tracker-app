...
| Tool | What it is | Used for |
|------|------------|----------|
| AlphaVantage | Stock market data API | Stock prices, history, and the symbol catalog. Free tier 25/day, cached 24h. |
| CoinGecko | Crypto data API | Coin prices, history, metadata, and catalog. Coins are identified by id ("bitcoin"), not ticker. |
